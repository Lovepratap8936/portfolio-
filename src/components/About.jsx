...
export default function About() {
  ...
  return (
    ...
    <br/>
    I fancy myself as a coder extraordinaire, fluent in the languages java and java script. They say I've even been known to have meaningful conversations with compilers – but that's just a rumor.
    <br/>
    ...
    <p className='skillname'>Java / Javascript</p>
    </div>
    <div className='skill'>
    ...
    <div className='journey' data-aos='fade-right'>
        ...
        <Educard
            ...
            name="Tulas Institute of Technology"
            marks="CGPA: 7.2"
            duration="2020-2024"
            className="first"
        />
